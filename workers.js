...
let userID = '17a30558-1d5d-4517-a4db-e80383ffa11a';
...
The following is the node information and sharing link of the non-TLS port，
Non-TLS ports supported by CF can be used:

Address: ${hostName} or CF preferred IP
Port: 80 or CF supported non-TLS port 
UUID: ${userID}
Transport: ws
Disguised domain name: ${hostName}
Path: /?ed=2048
...
The following is information on nodes and TLS port sharing links, 
You can use CF supported TLS ports:
...
Tips: If you use the workers.dev domain name, you cannot use the TLS port

---------------------------------------------------------------

For more tutorials, please pay attention to: Misaka’s broken website
`;
}
